      ...
      return _asyncToGenerator(function* ({
        ...
        const promises = components.map((c, i) => {
          ...
          c.getTemplateName().then(templateName => {
            var _res$__performanceTim;
            (_res$__performanceTim = res.__performanceTimer) === null || _res$__performanceTim === void 0 ? void 0 : _res$__performanceTim.mark(`${_performanceMarks.PERFORMANCE_MARKS.getProps}.${templateName}`, 'start');
          });
          return c.getProps ? c.getProps({
            ...
            c.getTemplateName().then(templateName => {
              var _res$__performanceTim2;
              (_res$__performanceTim2 = res.__performanceTimer) === null || _res$__performanceTim2 === void 0 ? void 0 : _res$__performanceTim2.mark(`${_performanceMarks.PERFORMANCE_MARKS.getProps}.${templateName}`, 'end');
            });
            return result;
          }) : Promise.resolve({});
        });
