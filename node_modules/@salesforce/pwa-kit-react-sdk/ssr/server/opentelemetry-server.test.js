...
describe('OpenTelemetry Server Tracing', () => {
  ...
  describe('initializeServerTracing', () => {
    ...
    test('should initialize with custom service name', () => {
      ...
      const result = initializeServerTracing(_objectSpread(_objectSpread({}, defaultOptions), {}, {
    ...
    test('should handle initialization errors gracefully', () => {
      ...
      expect(mockLogger.error).toHaveBeenCalledWith('Failed to initialize OpenTelemetry provider', {
        namespace: 'opentelemetry-server.initializeServerTracing',
        additionalProperties: {
          error: 'OpenTelemetry initialization failed'
        }
      });
  ...
  describe('shutdownServerTracing', () => {
    test('should successfully shutdown OpenTelemetry provider when provider exists', /*#__PURE__*/_asyncToGenerator(function* () {
    ...
    test('should handle shutdown when no provider exists', /*#__PURE__*/_asyncToGenerator(function* () {
    ...
    test('should handle shutdown errors gracefully', /*#__PURE__*/_asyncToGenerator(function* () {
      ...
      yield expect(shutdownServerTracing()).resolves.not.toThrow();

      // Verify error was logged
      expect(mockLogger.warn).toHaveBeenCalledWith('Failed to shutdown OpenTelemetry provider', {
  ...
  describe('isServerTracingInitialized', () => {
    ...
    test('should return false after shutdown', /*#__PURE__*/_asyncToGenerator(function* () {
      initializeServerTracing(defaultOptions);
      expect(isServerTracingInitialized()).toBe(true);
      yield shutdownServerTracing();
      expect(isServerTracingInitialized()).toBe(false);
  ...
  describe('integration scenarios', () => {
    test('should handle complete lifecycle: initialize -> shutdown', /*#__PURE__*/_asyncToGenerator(function* () {
      // Initialize
      const provider = initializeServerTracing(defaultOptions);
      expect(provider).toBeDefined();
      expect(isServerTracingInitialized()).toBe(true);
    ...
    test('should handle failed initialization followed by shutdown', /*#__PURE__*/_asyncToGenerator(function* () {
  ...
  describe('tracePerformance', () => {
    ...
    beforeEach(() => {
      ...
      otelApi.trace.setSpan.mockImplementation((ctx, span) => _objectSpread(_objectSpread({}, ctx), {}, {
        span
      }));
    ...
    test('should trace performance successfully', /*#__PURE__*/_asyncToGenerator(function* () {
      ...
      const result = yield tracePerformance('perf-test', mockFn, mockRes, mockReq);
    ...
    test('should handle function errors', /*#__PURE__*/_asyncToGenerator(function* () {
      ...
      yield expect(tracePerformance('perf-test', mockFn, mockRes, mockReq)).rejects.toThrow('Function failed');
    ...
    test('should inject B3 headers when tracing is enabled', /*#__PURE__*/_asyncToGenerator(function* () {
      ...
      yield tracePerformance('perf-test', mockFn, mockRes, mockReq);
    ...
    test('should not inject B3 headers when tracing is disabled', /*#__PURE__*/_asyncToGenerator(function* () {
      const originalEnv = process.env.OTEL_TRACING_ENABLED;
