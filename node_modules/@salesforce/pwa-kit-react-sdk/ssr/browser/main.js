...
const OuterApp = ({
  ...
  const dataStore = typeof window !== 'undefined' ? window[_constants.DATA_STORE_WINDOW_GLOBAL] : undefined;
  const siteId = dataStore ? dataStore[_constants.DATA_STORE_BOOTSTRAP_SITE_ID_KEY] : undefined;
  ...
  }, /*#__PURE__*/_react.default.createElement(_contexts.MrtDataStoreProvider, {
    siteId: siteId
