...
describe('PerformanceTimer', () => {
  ...
  describe('error handling and edge cases', () => {
    ...
    test('handles createChildSpan returning null', () => {
      ...
      const {
        createChildSpan
      } = jest.requireMock('./opentelemetry');
  ...
  describe('warning scenarios (non-test environment)', () => {
    ...
    test('warns for invalid mark type', () => {
      ...
      jest.clearAllMocks();
      timer.mark('test', 'invalid-type');
      expect(_loggerInstance.default.warn).toHaveBeenCalledWith('Invalid mark type', expect.objectContaining({
        type: 'invalid-type',
        name: 'test',
    ...
    test('warns when span already exists', () => {
      ...
      expect(_loggerInstance.default.warn).toHaveBeenCalledWith('Span already exists', expect.objectContaining({
        name: 'test',
        namespace: 'PerformanceTimer.mark'
      }));
    });
    test('error when performance.measure fails', () => {
      ...
      timer.mark('test', 'start');
      timer.mark('test', 'end');
      expect(_loggerInstance.default.error).toHaveBeenCalledWith('Failed to measure performance mark', expect.objectContaining({
        name: 'test',
    ...
    test('errors for invalid performance mark name (SyntaxError)', () => {
      ...
      timer.mark('test', 'start');
      expect(_loggerInstance.default.error).toHaveBeenCalledWith('Invalid performance mark name', expect.objectContaining({
        name: 'test',
    ...
    test('warns when cleaning up orphaned span', () => {
      ...
      expect(_loggerInstance.default.warn).toHaveBeenCalledWith('Cleaning up orphaned span', expect.objectContaining({
        name: 'test',
