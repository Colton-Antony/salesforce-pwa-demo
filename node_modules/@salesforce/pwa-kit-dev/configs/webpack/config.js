    ...
    constructor() {
      this.config = _objectSpread(_objectSpread({
        ...
        resolve: _objectSpread(_objectSpread({}, EXT_EXTENDS && EXT_OVERRIDES_DIR ? {
          ...
          conditionNames: [...(mode === 'development' ? ['dev-data-store'] : []), 'import', 'require', 'module', ...(target === 'web' ? ['browser'] : ['node']), 'default'],
...
const staticFolderCopyPlugin = new _copyWebpackPlugin.default({
  patterns: [{
    ...
    from: _path.default.resolve(projectDir, 'node_modules/@salesforce/storefront-next-runtime/dist/design-styles.css'),
...
const ruleForBabelLoader = babelPlugins => {
  ...
  {
    exclude: (0, _babelExclude.buildBabelExcludeRegex)(_path.default.sep, EXT_EXTENDS)
  } : {
    exclude: /node_modules/
  }), {}, {
    use: [{
