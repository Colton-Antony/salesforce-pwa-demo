...
var _babelExclude = require("./babel-exclude");
/*
...
describe('babel-loader exclude regex', () => {
  describe('on Windows (path.sep = backslash)', () => {
    const exclude = (0, _babelExclude.buildBabelExcludeRegex)('\\', EXT_EXTENDS);
    ...
    test('does NOT exclude the extends package', () => {
      expect(exclude.test('C:\\project\\node_modules\\@salesforce\\retail-react-app\\app\\index.jsx')).toBe(false);
    });
    test('excludes other @salesforce scoped packages', () => {
      expect(exclude.test('C:\\project\\node_modules\\@salesforce\\pwa-kit-runtime\\index.js')).toBe(true);
    });
  ...
  describe('on Unix (path.sep = /)', () => {
    ...
    test('does NOT exclude the extends package', () => {
      expect(exclude.test('/home/dev/project/node_modules/@salesforce/retail-react-app/app/index.jsx')).toBe(false);
    });
    test('excludes other @salesforce scoped packages', () => {
