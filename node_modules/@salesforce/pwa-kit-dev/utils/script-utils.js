...
class CloudAPIClient {
  ...
  push(bundle, projectSlug, target) {
    ...
    return _asyncToGenerator(function* () {
      ...
      const url = new URL(_this2.opts.origin);
  ...
  createLoggingToken(project, environment) {
    var _this3 = this;
    return _asyncToGenerator(function* () {
      const url = new URL(_this3.opts.origin);
      ...
      return new Promise((resolve, reject) => {
        ...
        const _check = /*#__PURE__*/function () {
          var _ref6 = _asyncToGenerator(function* () {
            const url = new URL(`/api/projects/${project}/target/${environment}`, _this4.opts.origin);
  ...
  var _ref7 = _asyncToGenerator(function* ({
    ...
    return Promise.resolve().then(() => (0, _fsExtra.stat)(buildDirectory)).catch(() => {
      ...
      archive.directory(buildDirectory, '', entry => {
        var _entry$stats;
        if ((_entry$stats = entry.stats) !== null && _entry$stats !== void 0 && _entry$stats.isFile() && entry.name) {
