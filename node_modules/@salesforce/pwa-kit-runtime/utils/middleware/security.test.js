...
describe('Content-Security-Policy enforcement', () => {
  ...
  test('adds required directives for production', () => {
    ...
    const ra = 'https://runtime.commercecloud.com ' + 'https://runtime-admin-staging.mobify-storefront.com ' + 'https://runtime-admin-preview.mobify-storefront.com ' + 'https://runtime-admin-soak.mobify-storefront.com ' + 'https://runtime-admin-testing.mobify-storefront-staging.com';
    expectDirectives([`connect-src 'self' ${ra} *.salesforce-scrt.com`, `frame-ancestors ${ra}`, "img-src 'self' data:", `script-src 'self' 'unsafe-eval' ${ra} *.site.com`, 'upgrade-insecure-requests']);
  });
