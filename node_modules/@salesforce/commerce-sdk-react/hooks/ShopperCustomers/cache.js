 ...
 */
const CLIENT_KEY = _constant.CLIENT_KEYS.SHOPPER_CUSTOMERS;
const noop = () => ({});
...
const cacheUpdateMatrix = exports.cacheUpdateMatrix = {
  ...
  updateCustomerPaymentInstrument(customerId, {
    parameters
  }, response) {
    const newParams = _objectSpread({}, parameters);
    return {
      update: [{
        ...
        updater: createUpdateFunction(customer => {
          ...
          if (idx >= 0) {
            ...
            if (response !== null && response !== void 0 && response.default) {
              customer.paymentInstruments = customer.paymentInstruments.map((pi, i) => i === idx ? pi : _objectSpread(_objectSpread({}, pi), {}, {
                default: false
              }));
            }
          }
