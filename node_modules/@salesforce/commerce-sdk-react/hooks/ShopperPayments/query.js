...
exports.usePaymentConfiguration = void 0;
 ...
 */
const CLIENT_KEY = _constant.CLIENT_KEYS.SHOPPER_PAYMENTS;
/**
 ...
 */
const usePaymentConfiguration = (apiOptions, queryOptions = {}) => {
  // ← Add this
  const client = (0, _useCommerceApi.default)(CLIENT_KEY);
  const methodName = 'getPaymentConfiguration';
  const requiredParameters = _commerceSdkIsomorphic.ShopperPayments.paramKeys[`${methodName}Required`]; // ← Add this

  // Parameters can be set in `apiOptions` or `client.clientConfig`;
  // we must merge them in order to generate the correct query key.
  const netOptions = (0, _utils.omitNullableParameters)((0, _utils.mergeOptions)(client, apiOptions));
  const parameters = (0, _utils.pickValidParams)(netOptions.parameters, _commerceSdkIsomorphic.ShopperPayments.paramKeys[methodName]); // ← Add this
...
exports.usePaymentConfiguration = usePaymentConfiguration;