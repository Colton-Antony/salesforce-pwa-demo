...
exports.getTaxesFromOrder = exports.getPaymentMethodsForOrder = exports.getOrder = exports.getOmsMetaData = void 0;
...
const getOmsMetaData = exports.getOmsMetaData = {
  path: params => ['/commerce-sdk-react', '/organizations/', params === null || params === void 0 ? void 0 : params.organizationId, '/orders/', '/oms-meta-data'],
  queryKey: params => {
    return [...getOmsMetaData.path(params), (0, _utils.pickValidParams)(params || {}, _commerceSdkIsomorphic.ShopperOrders.paramKeys.getOmsMetaData)];
  }
};