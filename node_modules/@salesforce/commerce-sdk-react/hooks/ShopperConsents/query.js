...
exports.useSubscriptions = void 0;
 ...
 */
const CLIENT_KEY = _constant.CLIENT_KEYS.SHOPPER_CONSENTS;
/**
 ...
 */
const useSubscriptions = (apiOptions, queryOptions = {}) => {
  const client = (0, _useCommerceApi.default)(CLIENT_KEY);
  const methodName = 'getSubscriptions';
  const requiredParameters = _commerceSdkIsomorphic.ShopperConsents.paramKeys[`${methodName}Required`];

  // Parameters can be set in `apiOptions` or `client.clientConfig`;
  // we must merge them in order to generate the correct query key.
  const netOptions = (0, _utils.omitNullableParameters)((0, _utils.mergeOptions)(client, apiOptions));
  const parameters = (0, _utils.pickValidParams)(netOptions.parameters, _commerceSdkIsomorphic.ShopperConsents.paramKeys[methodName]);
