...
function useShopperBasketsMutationHelper() {
  ...
  const createBasket = (0, _mutation.useShopperBasketsMutation)('createBasket');
  const addItemToBasketMutation = (0, _mutation.useShopperBasketsMutation)('addItemToBasket');
  return {
