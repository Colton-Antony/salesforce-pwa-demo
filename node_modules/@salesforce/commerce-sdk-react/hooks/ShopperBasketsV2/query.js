 ...
 */
const CLIENT_KEY = _constant.CLIENT_KEYS.SHOPPER_BASKETS_V2;
/**
 * Gets a basket.
...
const useBasket = (apiOptions, queryOptions = {}) => {
  ...
  const requiredParameters = _commerceSdkIsomorphic.ShopperBasketsV2.paramKeys[`${methodName}Required`];

  // Parameters can be set in `apiOptions` or `client.clientConfig`;
  // we must merge them in order to generate the correct query key.
  const netOptions = (0, _utils.omitNullableParameters)((0, _utils.mergeOptions)(client, apiOptions));
  const parameters = (0, _utils.pickValidParams)(netOptions.parameters, _commerceSdkIsomorphic.ShopperBasketsV2.paramKeys[methodName]);
