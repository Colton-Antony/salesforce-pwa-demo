...
declare const CLIENT_KEY: "shopperBasketsV2";
                ...
                bundledProductItems?: ({
                    ...
                    priceAdjustments?: ({
                        appliedDiscount?: ({
                            ...
                            type: "amount" | "percentage" | "fixed_price" | "free" | "price_book_price" | "bonus" | "total_fixed_price" | "bonus_choice" | "percentage_off_options";
                        } & {
                            [key: string]: any;
                        }) | undefined;
