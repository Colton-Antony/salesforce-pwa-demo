...
var _usePageDesignerParams = require("./usePageDesignerParams");
 ...
 */
const CLIENT_KEY = _constant.CLIENT_KEYS.SHOPPER_EXPERIENCE;
/**
...
const usePages = (apiOptions, queryOptions = {}) => {
  ...
  const {
    ...
    pdToken,
    pageId
  } = (0, _usePageDesignerParams.usePageDesignerParams)();
  ...
  const apiOptionsWithPDParams = _objectSpread(_objectSpread({}, apiOptions), {}, {
    parameters: _objectSpread({}, apiOptions.parameters)
  });

  // Parameters can be set in `apiOptions` or `client.clientConfig`;
  // we must merge them in order to generate the correct query key.
  const netOptions = (0, _utils.omitNullableParameters)((0, _utils.mergeOptions)(client, apiOptionsWithPDParams));
  const parameters = _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, (0, _utils.pickValidParams)(netOptions.parameters, _commerceSdkIsomorphic.ShopperExperience.paramKeys[methodName])), mode && {
    mode
  }), pdToken && {
    pdToken
  }), pageId && {
  ...
  const method = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(function* (options) {
      if (isPageDesignerMode) {
        const response = yield client[methodName](options, true);
