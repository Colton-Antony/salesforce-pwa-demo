...
import { ShopperBaskets, ShopperBasketsV2, ShopperConfigurations, ShopperConsents, ShopperContexts, ShopperCustomers, ShopperExperience, ShopperGiftCertificates, ShopperLogin, ShopperOrders, ShopperPayments, ShopperProducts, ShopperPromotions, ShopperSearch, ShopperSEO, ShopperStores } from 'commerce-sdk-isomorphic';
...
export type SDKClientTransformer<T> = (params: T, methodName: string, options: any) => any | Promise<any>;
