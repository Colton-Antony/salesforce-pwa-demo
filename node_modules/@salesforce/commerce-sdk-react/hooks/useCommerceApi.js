...
function useCommerceApi(clientName) {
  const apiClients = _react.default.useContext(_provider.CommerceApiContext);
  ...
  if (!client) {
    throw new Error(`Missing required client: ${String(clientName)}. ` + `Please initialize ${String(clientName)} class and provide it in CommerceApiProvider's apiClients prop.`);
  }
  return client;
}
