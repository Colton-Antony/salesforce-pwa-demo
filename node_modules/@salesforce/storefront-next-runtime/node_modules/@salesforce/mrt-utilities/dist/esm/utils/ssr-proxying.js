...
export const DEFAULT_ACCESS_CONTROL_FORWARDING_HOSTNAMES = ['.commercecloud.salesforce.com'];
export const hostnameMatchesTransformationList = (hostname, hostnameSuffixes) => {
 ...
 */
export const rewriteProxyRequestHeaders = ({ caching = false, headers, headerFormat = 'http', targetProtocol, targetHost, logging = false, accessControlHeaderForwardingHostnames, preserveUserAgent = true, }) => {
    if (!headers) {
        return {};
    }
