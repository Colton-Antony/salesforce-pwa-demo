 ...
 */
import { rewriteProxyRequestHeaders, rewriteProxyResponseHeaders } from './ssr-proxying.js';
 ...
 * ```
 */
export const applyProxyRequestHeaders = ({ proxyRequest, incomingRequest, caching = false, 
// eslint-disable-next-line @typescript-eslint/no-unused-vars
proxyPath, targetHost, targetProtocol, accessControlHeaderForwardingHostnames, preserveUserAgent, rewriteRequestHeaders: rewriteFn, }) => {
 ...
 * ```
 */
export const configureProxy = ({ appHostname, proxyPath, targetProtocol, targetHost, appProtocol = /* istanbul ignore next */ 'https', caching, accessControlHeaderForwardingHostnames, preserveUserAgent, }, createProxyFn) => {
    ...
    const proxyFunc = createProxy(config);
 ...
 * ```
 */
export const configureProxying = (proxyConfigs, appHostname, appProtocol = 'https', createProxyFn, accessControlHeaderForwardingHostnames, preserveUserAgent) => {
    const proxies = [];
...
//# sourceMappingURL=configure-proxying.js.map